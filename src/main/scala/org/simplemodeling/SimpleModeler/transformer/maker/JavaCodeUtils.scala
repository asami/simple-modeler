...
trait JavaCodeUtils {
  ...
  protected final def code_single_voucher_type(e: PEntityType) = {
    require (isNotBlank(e.entity.voucherName), "voucherName in PEntityType must have value.")
    e.entity.voucherName
  }

  protected final def code_multi_voucher_type(e: PEntityType) = {
    require (isNotBlank(e.entity.voucherName), "voucherName in PEntityType must have value.")
    "List<" + e.entity.voucherName + ">"
  }
  ...
  // Repository
  protected final def code_method_name_create(entity: PObject): String = {
    val classname = entity.name
    "create" + entity.name
  }

  protected final def code_method_name_create_tx(entity: PObject): String = {
    val classname = entity.name
    "create" + entity.name + "Tx"
  }

  protected final def code_method_name_create_id(entity: PObject): String = {
    val classname = entity.name
    "create" + entity.name + "Id"
  }

  protected final def code_method_name_create_id_tx(entity: PObject): String = {
    val classname = entity.name
    "create" + entity.name + "IdTx"
  }

  protected final def code_method_name_get(entity: PObject): String = {
    val classname = entity.name
    "get" + entity.name
  }

  protected final def code_method_name_get_tx(entity: PObject): String = {
    val classname = entity.name
    "get" + entity.name + "Tx"
  }

  protected final def code_method_name_get_doc(entity: PObject): String = {
    val classname = entity.name
    "get" + entity.name + "Voucher"
  }

  protected final def code_method_name_get_doc_tx(entity: PObject): String = {
    val classname = entity.name
    "get" + entity.name + "VoucherTx"
  }

  protected final def code_method_name_update(entity: PObject): String = {
    val classname = entity.name
    "update" + entity.name
  }

  protected final def code_method_name_update_tx(entity: PObject): String = {
    val classname = entity.name
    "update" + entity.name + "Tx"
  }

  protected final def code_method_name_delete(entity: PObject): String = {
    val classname = entity.name
    "delete" + entity.name
  }

  protected final def code_method_name_delete_tx(entity: PObject): String = {
    val classname = entity.name
    "delete" + entity.name + "Tx"
  }

  protected final def code_method_name_issue(entity: PObject): String = {
    val classname = entity.name
    "issue" + entity.name
  }

  protected final def code_method_name_issue_tx(entity: PObject): String = {
    val classname = entity.name
    "issue" + entity.name + "Tx"
  }

  protected final def code_method_name_issue_id(entity: PObject): String = {
    val classname = entity.name
    "issue" + entity.name + "Id"
  }

  protected final def code_method_name_issue_id_tx(entity: PObject): String = {
    val classname = entity.name
